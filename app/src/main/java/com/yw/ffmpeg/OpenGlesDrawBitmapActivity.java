 ...
 * @Package: com.yw.ffmpeg
 * @ClassName: OpenGlesDrawBitmapActivity
 * @Description: 使用opengles绘制图片
 * @Author: wei.yang
 * @CreateDate: 2021/3/23 16:55
 * @UpdateUser: 更新者：wei.yang
 * @UpdateDate: 2021/3/23 16:55
 * @UpdateRemark: 更新说明：
 * @Version: 1.0
 */
public class OpenGlesDrawBitmapActivity extends BaseActivity {
